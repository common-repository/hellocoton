...
function hellocoton_html() {
	...
	<a href="http://www.hellocoton.fr" target="_blank" style="display:block;width:27px;height:30px;position:absolute;top:0;left:120px;"><img src="'.$wpurl.'fa.gif" border="0" alt="Rendez-vous sur Hellocoton !" style="'.$style.'" /></a></span>';
...
function hellocoton_feed_html() {
	...
	<a href="http://www.hellocoton.fr" target="_blank" style="display:block;width:27px;height:30px;position:absolute;top:0;left:120px;"><img src="'.$wpurl.'fa.gif" border="0" alt="Rendez-vous sur Hellocoton !" style="padding:0;border:0;margin:0;float:none;" /></a></span>';
